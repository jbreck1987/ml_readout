...
in this experiment is the normalized phase response peaks.
"""
...
def main():
    ...
    with mlflow.start_run():
        ...
        for epoch in range(EPOCHS):
            ...
            mlflow.log_metric('train_error_arrival', train_metrics['0']['acc'], epoch)
            mlflow.log_metric('train_error_height', train_metrics['1']['acc'], epoch)
            mlflow.log_metric('test_error_arrival', test_metrics['0']['acc'], epoch)
            mlflow.log_metric('test_error_height', test_metrics['1']['acc'], epoch)
